const posts = [
    {
      ...
      title: 'Q3',
      href: '#',
      description:['- Official launch of EXPay.','- Integration with XinFin Network and IoT devices.', '- Partnerships with major cargo transportation businesses in the USA.'],
      date: '2023',
      datetime: '2020-03-16',
    ...
    },
    {
      ...
      title: 'Q2',
      href: '#',
      description:['- Release of EXPay white-label solutions.','- Enhancement of smart contract capabilities.', '- Expansion to African markets.'],
      date: '2024',
      datetime: '2020-03-16',
      category: { title: 'Marketing', href: '#' },
    },
    ...
    },
    {
      ...
      title: 'Q4',
      href: '#',
      description:['- Continuous refinement and enhancement of EXPay platform based on user feedback and industry trends.','- Ongoing global expansion and partnerships.', '- Exploration and adoption of new technologies to further improve EXPay.'],
