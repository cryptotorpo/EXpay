        ...
        <div className="px-6 mx-auto max-w-7xl lg:px-8">
          <div className="max-w-2xl mx-auto lg:mx-0">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              We usher in a new era of digital transformation, industries around the world are seeking innovative ways to streamline operations and improve efficiency.
            </p>
          </div>
